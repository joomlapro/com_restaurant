		...
		<div class="filters pull-left">
			...
			<?php if ($this->state->get('filter.forcedLanguage')): ?>
				<select name="filter_category_id" id="filter_category_id" class="input-medium" onchange="this.form.submit()">
					...
					<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_restaurant', array('filter.language' => array('*', $this->state->get('filter.forcedLanguage')))), 'value', 'text', $this->state->get('filter.category_id')); ?>
				</select>
			...
			<?php else: ?>
				<select name="filter_category_id" id="filter_category_id" class="input-medium" onchange="this.form.submit()">
					<option value=""><?php echo JText::_('JOPTION_SELECT_CATEGORY'); ?></option>
					<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_restaurant'), 'value', 'text', $this->state->get('filter.category_id')); ?>
				</select>
