...
/**
 * Dish controller for Restaurant Component.
 *
 * @package     Restaurant
 * @subpackage  com_restaurant
 * @author      Bruno Batista <bruno@atomtech.com.br>
...
class RestaurantControllerDish extends JControllerForm
{
	...
	protected function allowAdd($data = array())
	{
		...
		if ($categoryId)
		{
			...
			$allow = $user->authorise('core.create', 'com_restaurant.category.' . $categoryId);
		}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		$user     = JFactory::getUser();
		$userId   = $user->get('id');
		$asset    = 'com_restaurant.dish.' . $recordId;
	 ...
	 * @since   3.2
	 */
	public function getModel($name = 'Dishform', $prefix = 'RestaurantModel', $config = array('ignore_request' => true))
	{
